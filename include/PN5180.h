...
#define GENERAL_ERROR_IRQ_STAT (1UL << 17) // General error IRQ
#define LPCD_IRQ_STAT (1UL << 19)          // LPCD Detection IRQ
...
public:
  ...
  uint8_t readRFResponse(uint8_t *buffer, uint8_t maxLen);
  /* cmd 0x0B */
